...
const CACHE = "recibos-v9";
const SHELL = ["./", "index.html", "app.js?v=9", "parser.js?v=9", "cloud.js?v=9", "firebase-config.js?v=9", "manifest.webmanifest", "icon.svg", "icon-192.png", "icon-512.png"];
