...
const CACHE = "recibos-v5";
const SHELL = ["./", "index.html", "app.js?v=5", "parser.js?v=5", "cloud.js?v=5", "firebase-config.js", "manifest.webmanifest", "icon.svg", "icon-192.png", "icon-512.png"];
