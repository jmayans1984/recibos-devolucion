...
const CACHE = "recibos-v10";
const SHELL = ["./", "index.html", "app.js?v=10", "parser.js?v=10", "cloud.js?v=10", "firebase-config.js?v=10", "manifest.webmanifest", "icon.svg", "icon-192.png", "icon-512.png"];
