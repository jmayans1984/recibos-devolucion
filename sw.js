...
const CACHE = "recibos-v6";
const SHELL = ["./", "index.html", "app.js?v=6", "parser.js?v=6", "cloud.js?v=6", "firebase-config.js?v=6", "manifest.webmanifest", "icon.svg", "icon-192.png", "icon-512.png"];
